...
const addFavourite = (el) => {
  ...
  const designer = el.target.parentNode.parentNode.dataset.designer
  const img = el.target.parentNode.parentNode.dataset.image
  const url = window.location.pathname
  const dressname = el.target.parentNode.parentNode.parentNode.parentNode.innerText
...
const checkFavourite = (el) => {
  ...
  const dressname = target.parentNode.parentNode.parentNode.parentNode.innerText
  const designer = target.parentNode.dataset.designer
  const img = target.parentNode.dataset.image
  const url = window.location.pathname
