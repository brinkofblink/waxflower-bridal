/*
 ...
 MyFonts Webfont Build ID 3626300, 2018-08-23T16:35:10-0400
 ...
 License: https://www.myfonts.com/viewlicense?type=web&buildid=3626300
...
count.async = !0;
count.src = protocol + "//hello.myfonts.net/count/37553c";
...
for (var fonts = [{
    ...
    fontWeight: "bold",
    fontStyle: "normal",
    url: wfpath + "37553C_0" + suffix + "_0." + webfontType
  }, {
    fontFamily: "BrandonGrotesque",
    fontWeight: "normal",
    fontStyle: "normal",
    url: wfpath + "37553C_1" + suffix + "_0." + webfontType
  ...
  var format = "svg#wf" == webfontType ? 'format("svg")' : "ttf" == webfontType ? 'format("truetype")' : "eot" == webfontType ? "" : 'format("' + webfontType + '")',
    css = css + ("@font-face{font-family: " + fonts[i].fontFamily + ";src:url(" + fonts[i].url +
      ")" + format + ";");
