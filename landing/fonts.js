/*
 ...
 MyFonts Webfont Build ID 3620189, 2018-08-08T15:37:04-0400
 ...
 License: https://www.myfonts.com/viewlicense?type=web&buildid=3620189
...
count.async = !0;
count.src = protocol + "//hello.myfonts.net/count/373d5d";
  ...
  if (regex.test(navigator.userAgent)) {
    ...
    for (var j = 0; j < typeLen; j++)
      if (
        ...
        (1 == browsers[i].unhinted && (suffix = "_unhinted"),
...
for (
  var fonts = [{
        ...
        fontWeight: "bold",
        fontStyle: "normal",
        url: wfpath + "373D5D_0" + suffix + "_0." + webfontType
      },
      {
        fontFamily: "BrandonGrotesque",
        fontWeight: "normal",
        fontStyle: "normal",
        url: wfpath + "373D5D_1" + suffix + "_0." + webfontType
      }
    ],
    len = fonts.length,
    css = "",
